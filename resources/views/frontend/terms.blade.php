...
<div class="bg-slate-900 text-white py-16 md:py-24">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-black tracking-tight mb-4">Syarat & Ketentuan</h1>
        <p class="text-lg text-slate-400 max-w-2xl mx-auto font-light">Harap baca dengan cermat ketentuan penggunaan layanan {{ config('app.name', 'Mindu') }}.</p>
    </div>
</div>
...
<div class="bg-white dark:bg-slate-900 py-16 md:py-24 transition-colors duration-300 min-h-[50vh]">
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        @if(empty(trim($terms_conditions)) || $terms_conditions == 'Syarat & Ketentuan belum tersedia.')
