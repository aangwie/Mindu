<x-admin-layout>
    <div class="mb-8">
        ...
        <p class="text-slate-600">Perbarui pertanyaan psikotest RIASEC dan pilihan jawabannya.</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="question_text" name="question_text" rows="4" required
                                class="block w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-blue-500 focus:border-blue-500 transition duration-150">{{ old('question_text', $question->question_text) }}</textarea>
                        </div>
                ...
                <div class="flex justify-end gap-4 mt-8">
                    ...
                    <button type="submit" class="px-10 py-3 bg-blue-600 border border-transparent rounded-xl font-bold text-sm text-white uppercase tracking-widest hover:bg-blue-700 transition shadow-lg shadow-blue-100">Perbarui Soal</button>
                </div>
            </div>
