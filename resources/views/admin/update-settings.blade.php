            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <div class="p-6">
                    <form action="{{ route('admin.update-settings.token') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="github_token" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">GitHub PAT</label>
                                <div class="relative" x-data="{ show: false }">
                                    <input :type="show ? 'text' : 'password'" name="github_token" id="github_token" value="{{ $githubToken }}" placeholder="github_pat_xxxx" 
                                           class="w-full rounded-xl border-slate-200 dark:border-slate-700 dark:bg-slate-900 dark:text-white focus:ring-blue-500 focus:border-blue-500 @error('github_token') border-red-500 @enderror pr-10">
