...
<body x-data="adminLayout()" x-init="init()" class="bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 antialiased min-h-screen">
    ...
    <aside :style="sidebarVisible ? 'transform: translateX(0)' : 'transform: translateX(-100%)'"
        ...
        <nav class="flex-grow py-6 px-3 space-y-1 overflow-y-auto overflow-x-hidden">
            ...
            <a href="/admin/users" class="flex items-center px-4 py-3 text-sm font-medium rounded-xl group transition-all {{ request()->is('admin/users*') ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 shadow-sm' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700/50 hover:text-slate-900 dark:hover:text-slate-200' }}" :title="minimized ? 'Manajemen Siswa' : ''">
                ...
                <span x-show="!minimized" x-transition.opacity>Manajemen User</span>
            </a>
            ...
            <a href="/admin/tc" class="flex items-center px-4 py-3 text-sm font-medium rounded-xl group transition-all {{ request()->is('admin/tc*') ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 shadow-sm' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700/50 hover:text-slate-900 dark:hover:text-slate-200' }}" :title="minimized ? 'T&C' : ''">
                <svg class="w-5 h-5 shrink-0" :class="minimized ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
                <span x-show="!minimized" x-transition.opacity>T&C</span>
            </a>
